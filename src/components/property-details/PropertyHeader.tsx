      ...
      <div className="max-w-[1280px] mx-auto px-8 py-8">
        <div className="flex items-start justify-between gap-8">
          ...
          <div className="text-right">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="font-space-mono font-bold text-4xl text-[#E0B030]">
                {price}
              </span>
            </div>
          </div>
        ...
        <div className="flex items-center gap-12 mt-8 pt-8 border-t border-[rgba(229,224,216,0.6)]">
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="w-12 h-12 bg-[rgba(224,176,48,0.1)] rounded-lg flex items-center justify-center">
