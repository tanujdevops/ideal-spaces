  ...
  return (
    <div className="mb-12">
      ...
      <div className="flex items-center gap-3 mb-6">
        <div className="w-1 h-6 bg-[#E0B030] rounded-full" />
      ...
      {/* Address Card */}
      <div className="bg-white border border-[#F2DFA8] rounded-xl p-6 mb-6">
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 bg-[rgba(224,176,48,0.1)] rounded-full flex items-center justify-center flex-shrink-0">
            <MapPin className="w-5 h-5 text-[#E0B030]" />
          </div>
          ...
          {googleMapLink && (
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[#E0B030] hover:text-[#C8911F] font-manrope text-sm font-medium shrink-0 transition-colors"
            >
              Open in Maps
      ...
      {/* Map / Placeholder */}
      <div className="relative aspect-[690/280] rounded-xl overflow-hidden border border-[#F2DFA8] bg-gray-100">
        {hasMap ? (
          <iframe
            src={embedUrl}
            width="100%"
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#FBF7EF] to-[#F2DFA8] flex flex-col items-center justify-center gap-3">
            <div className="w-16 h-16 bg-white/80 rounded-full flex items-center justify-center shadow-sm">
              <MapPin className="w-8 h-8 text-[#E0B030]/60" />
            </div>
