      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {amenities.map((amenity, index) => {
          ...
          return (
            <div
              key={index}
              className="flex items-center gap-3 bg-[#FFFCF7] border border-[#F2DFA8] rounded-xl px-4 py-3 transition-all hover:border-[#E0B030]/30 hover:shadow-sm"
            >
              <div className="w-9 h-9 bg-[rgba(224,176,48,0.1)] rounded-lg flex items-center justify-center shrink-0">
                <Icon className="w-[18px] h-[18px] text-[#E0B030]" />
              </div>
