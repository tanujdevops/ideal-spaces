...
const ScheduleViewingCard: React.FC<ScheduleViewingCardProps> = ({ property }) => {
  ...
  if (success) {
    return (
      <div className="bg-white border border-[#F2DFA8] rounded-2xl p-8 shadow-lg sticky top-8 text-center">
        ...
        <button
          ...
          className="text-[#E0B030] font-manrope font-semibold text-sm hover:underline"
        >
  ...
  return (
    <div className="bg-white border border-[#F2DFA8] rounded-2xl p-8 shadow-lg sticky top-8">
      {/* Header */}
      <div className="flex items-center gap-2 mb-6">
        <span className="material-icons text-[#E0B030] text-xl">
          calendar_today
        </span>
      ...
      {/* Agent Info */}
      <div className="flex items-center gap-4 mb-6 pb-6 border-b border-[#F2DFA8]">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-[#FBF7EF] border border-[#F2DFA8] rounded-lg px-4 py-3 font-manrope font-extralight text-sm text-[#0F172A] placeholder:text-[#94A3B8] focus:outline-none focus:border-[#E0B030] transition-colors"
            required
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            value={formData.date}
            onChange={handleInputChange}
            className="w-full bg-[#FBF7EF] border border-[#F2DFA8] rounded-lg px-4 py-3 font-manrope font-extralight text-sm text-[#0F172A] focus:outline-none focus:border-[#E0B030] transition-colors"
            required
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={handleInputChange}
            className="w-full bg-[#FBF7EF] border border-[#F2DFA8] rounded-lg px-4 py-3 font-manrope font-extralight text-sm text-[#0F172A] focus:outline-none focus:border-[#E0B030] transition-colors appearance-none cursor-pointer"
            required
            style={{
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full bg-[#E0B030] hover:bg-[#B98215] disabled:opacity-60 disabled:cursor-not-allowed text-[#221410] font-manrope font-bold text-base py-3.5 rounded-xl transition-all shadow-lg hover:shadow-xl mt-6"
        >
