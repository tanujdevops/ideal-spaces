...
const PropertiesHeader: React.FC<PropertiesHeaderProps> = ({ 
  ...
  return (
    <div className="border-b border-[#F2DFA8] bg-white sticky top-0 z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-white border border-[#F2DFA8] rounded-lg px-4 py-2 font-manrope text-sm text-[#221410] cursor-pointer focus:outline-none focus:border-[#E0B030] appearance-none pr-8 bg-no-repeat bg-right"
                style={{
            ...
            {/* View Toggle */}
            <div className="flex items-center gap-1 bg-[#FFFFFF] rounded-lg p-1">
              <button
                onClick={() => handleViewChange('grid')}
                className={`p-2 rounded transition-all ${
                  viewMode === 'grid'
                    ? 'bg-white text-[#E0B030] shadow-sm'
                    : 'text-[#6B7280] hover:text-[#E0B030]'
                }`}
                title="Grid View"
              >
