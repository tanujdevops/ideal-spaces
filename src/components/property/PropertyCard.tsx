  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 cursor-pointer">
      <div className="relative h-64">
        ...
        {featured && (
          <div className="absolute top-4 left-4 bg-[#E0B030] text-[#221410] px-3 py-1 rounded-lg font-manrope font-bold text-xs">
            FEATURED
          </div>
        )}
        {aiMatch && (
          <div className="absolute top-4 right-4 bg-[rgba(224,176,48,0.1)] px-2 py-1 rounded">
            <span className="font-manrope font-bold text-xs text-[#E0B030]">AI MATCH: {aiMatch}%</span>
          </div>
        )}
      </div>
      <div className="p-6">
