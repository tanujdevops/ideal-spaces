      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="flex items-center justify-between mb-10">
          <div className="flex items-baseline gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-[#E0B030] rounded-full animate-pulse" />
          ...
          <button className="font-space-mono text-sm text-[#221410] border-b border-[#221410] hover:text-[#E0B030] hover:border-[#E0B030] transition-colors pb-1">
            View All → See more
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {properties.map((property) => (
            <div 
              key={property.id}
              className="bg-white border border-[#F2DFA8] rounded-xl overflow-hidden hover:shadow-2xl transition-all group cursor-pointer"
            >
              {/* Image */}
              <div className="relative aspect-[382/286.5] overflow-hidden">
                ...
                {/* Badge */}
                <div className="absolute top-4 left-4 bg-[#E0B030] text-[#221410] font-space-mono text-xs px-3 py-1.5 rounded-full shadow-lg">
                  {property.badge}
                </div>
