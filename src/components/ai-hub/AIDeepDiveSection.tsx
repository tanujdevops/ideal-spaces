    ...
    <section className="bg-white py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white border border-[#F2DFA8] rounded-xl overflow-hidden shadow-lg">
            {/* Image */}
            <div className="relative aspect-[382/286.5] overflow-hidden">
              ...
              {/* Match Badge */}
              <div className="absolute bottom-4 left-4 backdrop-blur-md bg-white/90 border border-[#F2DFA8] rounded px-3 py-2 shadow-lg">
            ...
            {/* Market Badge */}
            <div className="bg-[rgba(224,176,48,0.1)] border-b border-[rgba(224,176,48,0.2)] px-6 py-4 flex items-center justify-between">
              <span className="font-syne text-xs text-[#B55D45] uppercase tracking-wider">
                Under Market Value
              </span>
              <TrendingDown className="w-5 h-5 text-[#E0B030]" />
            </div>
            ...
            <div className="p-6">
              ...
              <p className="font-space-mono font-bold text-lg text-[#E0B030] mb-4">
                $2,400,000
              </p>
              ...
              {/* Specs */}
              <div className="flex items-center divide-x divide-[rgba(229,214,177,0.5)] border-t border-[rgba(229,214,177,0.5)] pt-4">
          ...
          <div className="space-y-6">
            {/* Market Scoring */}
            <div className="bg-[#FFFFFF] border border-[#F2DFA8] rounded-xl p-6">
                ...
                {analysisData.marketScoring.map((item, index) => (
                  <div key={index}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="font-space-mono font-bold text-sm text-[#E0B030]">
                        {item.score}%
                      </span>
                    </div>
                    <div className="h-2 bg-[#F2DFA8] rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-[#E0B030] rounded-full transition-all duration-500"
              ...
              <div className="grid grid-cols-3 gap-4">
                {analysisData.investmentMetrics.map((metric, index) => (
                  <div key={index} className="text-center">
                    <div className="font-space-mono font-bold text-2xl text-[#E0B030] mb-1">
                      {metric.value}
                    </div>
            ...
            <div className="bg-[#E0B030] text-[#221410] rounded-xl p-6 flex items-center justify-between">
              <div>
