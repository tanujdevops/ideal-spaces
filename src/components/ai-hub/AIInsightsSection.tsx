      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="w-16 h-16 bg-[rgba(224,176,48,0.1)] rounded-full flex items-center justify-center mx-auto mb-6">
            <Brain className="w-8 h-8 text-[#E0B030]" strokeWidth={1.5} />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {insights.map((insight, index) => (
            <div 
              key={index}
              className="bg-[#FFFFFF] border border-[#F2DFA8] rounded-xl p-8 hover:shadow-xl transition-all group"
            >
              {/* Icon */}
              <div className="w-12 h-12 bg-[rgba(224,176,48,0.1)] rounded-full flex items-center justify-center mb-6 group-hover:bg-[rgba(224,176,48,0.15)] transition-colors">
                <insight.icon className="w-6 h-6 text-[#E0B030]" strokeWidth={1.5} />
              </div>
