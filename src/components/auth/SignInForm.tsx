      ...
      <div className="flex items-center justify-between">
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            onChange={handleInputChange}
            className="w-4 h-4 rounded border-[#F2DFA8] text-[#E0B030] focus:ring-[#E0B030]"
          />
        ...
        <Link
          to="/forgot-password"
          className="font-manrope font-medium text-sm text-[#E0B030] hover:text-[#B98215] transition-colors"
        >
          Forgot Password?
        </Link>
      </div>
