...
const ContactFormCard: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Map form fields to the local frontend-only service shape.
  ...
  return (
    <div className="bg-white border border-[#F2DFA8] rounded-2xl p-8 shadow-sm">
      {/* Card Header */}
      <div className="mb-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={5}
            className="w-full bg-[#FBF7EF] border border-[#F2DFA8] rounded-lg px-4 py-3 font-manrope font-extralight text-sm text-[#0F172A] placeholder:text-[#94A3B8] focus:outline-none focus:border-[#E0B030] transition-colors resize-none"
            required
          />
        </div>
