...
const NewsletterBanner: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Frontend-only demo: capture and clear the input locally.
    setEmail('');
  };

  return (
    <section className="bg-[#B98215] py-16">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 max-w-[500px] w-full">
            <form onSubmit={handleSubmit} className="flex gap-3">
              ...
              <button
                type="submit"
                className="bg-white hover:bg-[#FBF7EF] text-[#B98215] font-manrope font-bold text-base px-8 py-3.5 rounded-xl transition-all shadow-lg hover:shadow-xl whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
