            ...
            <>
              <div className="text-center mb-8">
                <div className="w-14 h-14 bg-[#FBF7EF] rounded-full flex items-center justify-center mx-auto mb-5">
                  <Lock className="w-7 h-7 text-[#E0B030]" />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#FBF7EF] border border-[#F2DFA8] rounded-xl pl-12 pr-12 py-3.5 font-manrope text-sm text-[#221410] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#E0B030] focus:ring-1 focus:ring-[#E0B030] transition-all"
                      required
                    />
                    <button
                      type="button"
                        ...
                        {[1, 2, 3, 4, 5].map((level) => (
                          <div
                            ...
                            className={`h-1.5 flex-1 rounded-full transition-colors ${
                              level <= passwordStrength ? getStrengthColor() : 'bg-[#F2DFA8]'
                            }`}
                          />
                        ))}
                      </div>
