      ...
      <div className="bg-white min-h-screen">
        ...
        <div className="flex items-center justify-center py-32">
          <div className="text-center">
            <span className="material-icons text-5xl text-[#E0B030] mb-4">error_outline</span>
            <p className="font-manrope text-xl text-[#374151] mb-4">{error || 'Property not found'}</p>
            <Link
              to="/properties"
              className="bg-[#E0B030] text-[#221410] font-manrope font-bold px-8 py-3 rounded-lg hover:bg-[#C8911F] transition-all inline-block"
            >
              Back to Properties
            </Link>
          </div>
